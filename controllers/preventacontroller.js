...
const { validartranscaccion } = require('./ldab');
  ...
  try {
   ...
   // console.log("datos del comprador", usuario)//datos de quien esta haceindo la transsaccion
    ...
    //  console.log("referido de primer nivel", referido1)
      ...
      await validartranscaccion(objreferido1$)//validar que el usuario exista
    // Suponiendo que ambos valores son números
      referido1.usdcomision = Number(referido1.usdcomision) + Number(valor1por.toFixed(2));
      referido1.save()
      ...
      //  console.log("referido de 2 nivel", referido2)
        ...
        referido2.usdcomision=Number(referido2.usdcomision)+ Number(valor2por.toFixed(2))
        referido2.save()
        if (referido2.referido.length > 0) {
          ...
          referido3.usdcomision=Number(referido3.usdcomision)+ Number(valor3por.toFixed(2))
          referido3.save()
          if (referido3.referido.length > 0) {
           ...
           // console.log("referido de 4 nivel", referido3)
            ...
            referido4.usdcomision=Number(referido4.usdcomision)+ Number(valor4por.toFixed(2))
            referido4.save()
          }
        }
      }
    ...
    console.log("datos del valor total",typeof fases.valortotalVen),
console.log("datos del valor total",fases.valortotalVen),
console.log("datos de la fase",typeof precioTotal)
    console.log("datos de la fase",precioTotal)
   fases.valortotalVen = (fases.valortotalVen + precioTotal).toFixed(2);
